    ...
    Statement = [
      {
        ...
        // 👇 గమనిక: సమస్యను పరిష్కరించడానికి ఇక్కడ Condition బ్లాక్ తొలగించబడింది.
        // Condition బ్లాక్‌ను తొలగించడం ద్వారా, Policy అమలులో ఉన్న కఠినమైన నియమాలు తొలగించబడతాయి.
      },
    ]
  })
}